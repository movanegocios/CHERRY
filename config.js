  ...
  i18n: {
    ...
    pt: {
      ...
      boost: {
        ...
        badge_title: "Cherry Boost",
        badge_text: "Estrutura + Movimento = Resultado real para o seu negócio.",
        items: [
      ...
      diagnostic: {
        ...
        smart_label: "Diagnóstico inteligente",
        smart_hint: "Preencha os dados principais para receber um atendimento mais preciso.",
        hints: {
          name: "Use seu nome para facilitar o atendimento.",
          whatsapp: "Digite com DDD. Exemplo: (11) 99999-9999.",
          company: "Pode ser o nome da empresa, projeto ou perfil.",
        ...
        validation: {
          ...
          improve: "Escolha o que você deseja melhorar.",
          interest: "Escolha o interesse principal."
        },
        fields: {
          name: "Seu nome",
    ...
    en: {
      ...
      boost: {
        ...
        badge_title: "Cherry Boost",
        badge_text: "Structure + Movement = Real results for your business.",
        items: [
      ...
      diagnostic: {
        ...
        smart_label: "Smart assessment",
        smart_hint: "Fill in the main details to receive more precise service.",
        hints: {
          name: "Use your name to make service easier.",
          whatsapp: "Enter your number with country or area code.",
          company: "This can be your company, project or profile name.",
          segment: "Example: restaurant, clinic, store, barbershop.",
          improve: "Choose the main bottleneck you want to solve.",
          interest: "Choose the solution that best matches your current moment.",
          message: "Optional. Tell us what is blocking your service or sales."
        },
        validation: {
          name: "Your name is required.",
          whatsapp: "Enter a valid WhatsApp number.",
          improve: "Choose what you want to improve.",
          interest: "Choose your main interest."
        },
        fields: {
          name: "Your name",
    ...
    es: {
      ...
      boost: {
        ...
        badge_title: "Cherry Boost",
        badge_text: "Estructura + Movimiento = Resultado real para tu negocio.",
        items: [
      ...
      diagnostic: {
        ...
        trust: [
          ...
          "Respuesta en hasta 24 horas",
          "Sin spam. Tus datos son privados."
        ],
        smart_label: "Diagnóstico inteligente",
        smart_hint: "Completa los datos principales para recibir una atención más precisa.",
        hints: {
          name: "Usa tu nombre para facilitar la atención.",
          whatsapp: "Ingresa tu número con código de país o área.",
          company: "Puede ser el nombre de la empresa, proyecto o perfil.",
          segment: "Ejemplo: restaurante, clínica, tienda, barbería.",
          improve: "Elige el principal cuello de botella que quieres resolver.",
          interest: "Elige la solución que más combina con tu momento.",
          message: "Opcional. Cuenta qué está frenando tu atención o tus ventas."
        },
        validation: {
          name: "Tu nombre es obligatorio.",
          whatsapp: "Ingresa un WhatsApp válido.",
          improve: "Elige qué deseas mejorar.",
          interest: "Elige el interés principal."
        },
        fields: {
          name: "Tu nombre",
